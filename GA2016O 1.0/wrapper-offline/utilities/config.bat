...
setlocal
if "%SUBSCRIPT%"=="" ( pushd "C:\Users\user\Desktop\THE AKR FOLDER REBORN\wrapper offline 2016\GA2016O 1.0\wrapper-offline\utilities\" & start notepad.exe config.bat & exit )
endlocal
